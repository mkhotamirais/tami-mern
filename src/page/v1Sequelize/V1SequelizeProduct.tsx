...
import V1MysqlProductList from "./V1SequelizeProductList";
import { useV1Sequelize } from "@/hooks/useV1Sequelize";

export default function V1SequelizeProduct() {
  const { data, getData, loadData, errData } = useV1Sequelize();
    ...
    <div className="max-w-xl mx-auto">
      <div className="flex justify-between items-center">
        ...
        <Button size={"sm"} asChild>
          <Link to="/v1-sequelize/product-create">Add New</Link>
        </Button>
      </div>
