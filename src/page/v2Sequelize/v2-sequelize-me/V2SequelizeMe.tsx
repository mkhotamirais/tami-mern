...
import V3MeDelDialog from "./V2SequelizeMeDelDialog";
...
export default function V2SequelizeMe() {
  const { refresh, me, accessToken, loadMe, errMe } = useV2Sequelize();
  ...
  const onSubmit = (values: UpdateMeForm) => {
    ...
    axios
      ...
      .patch(`${urlSequelize}/v2/me`, values, { headers: { Authorization: `Bearer ${accessToken}` } })
      .then((res) => {
